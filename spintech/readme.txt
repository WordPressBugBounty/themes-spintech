...
Spintech WordPress Theme, Copyright 2024 Burger Software
...
@version 1.0.67
* Fixed styling issue in block files.
...
@version 1.0.64
* Woo Product Style Fixed

@version 1.0.63
* Fixed Block Style Margin

@version 1.0.62
* Fixed- Block Calendar Font Weight

@version 1.0.61
* WordPress 6.9 Tested

@version 1.0.60
* Block Image Caption Style Improvement
...
@version 1.0.52
* Fixed Creation of dynamic property Fixed 

@version 1.0.51
* Block WooCommerce Cart Style Improved
* WordPress 6.5 Tested

@version 1.0.50
* Style Improvement - WP Block Calendar Widget
...
@version 1.0.48
* Post Navigation Style Issue Fixed 

@version 1.0.47
* WooCommerce Block Style Issue Fixed

@version 1.0.46
* Block Rss Widget Style Issue Fixed
...
@version 1.0.38
* Fixed Block Comment Padding Issue
...
@version 1.0.34
* Fixed Block Search Styles Issues
